...
The sample average of 𝜇̂  across tests for which the null is rejected approximately equal to the average estimate of 𝜇̂ when the true mean is greater than or equal to 4. The red line peaks at 1 because that's where the most extreme 5% of all the samples are, which shows extreme bias. And it slowly merges with the black line when true mean is 4 or more since more and more samples are significant
